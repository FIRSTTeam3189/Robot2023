...
TwoScoreHighCubeUltrashootAuto::TwoScoreHighCubeUltrashootAuto(SwerveDrive *swerve, pathplanner::SwerveAutoBuilder *builder, std::string filePath) : m_swerve(swerve) {
