...
TwoCargo::TwoCargo(SwerveDrive *swerveDrive, Elevator *elevator, Shooter *shooter, Intake *intake) 
: m_swerve(swerveDrive), m_elevator(elevator), m_shooter(shooter), m_intake(intake) {
