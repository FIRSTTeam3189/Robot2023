...
namespace AutoConstants {
    ...
    constexpr int gyroAutoBalanceSettleLoops {50};  
...
#define OUTTAKE_ROLLER_POWER -0.4
...
#define ELEVATOR_HIGH_CUBE_TARGET 2875
#define ELEVATOR_LOW_CONE_TARGET 1500
#define ELEVATOR_MID_CONE_TARGET 2400
#define ELEVATOR_HIGH_CONE_TARGET 2875
#define ELEVATOR_DOUBLE_SUBSTATION_CUBE_TARGET 2575
#define ELEVATOR_DOUBLE_SUBSTATION_CONE_TARGET 2800
