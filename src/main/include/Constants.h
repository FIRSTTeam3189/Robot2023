...
#define INTAKE_ROLLER_POWER 0.1
#define INTAKE_CONVEYOR_POWER 0.1
#define INTAKE_CONE_CORRECT_POWER 0.1

#define ELEVATOR_MOTOR 2
#define ELEVATOR_P 0.1
#define ELEVATOR_SLOW_P 0.01
#define ELEVATOR_I 0
#define ELEVATOR_D 0
...
#define GRABBER_MOTOR_ID 3
#define GRABBER_DROP_SPEED 0.25
#define GRABBER_GRAB_SPEED -0.15
